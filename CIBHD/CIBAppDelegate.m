...
#import "CIBAppDelegate.h"
#import "LWViewModelServicesImpl.h"
#import "CIBWelcomeViewModel.h"

@interface CIBAppDelegate ()
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [self.services resetRootViewModel:[[CIBWelcomeViewModel alloc] initWithServices:self.services params:nil]];
